...
export class PDFGenerator implements OutputGenerator {
  format = 'pdf';
  name = 'PDF Generator';
  ...
  private async generateHTML(
    ...
    const diagramMap = new Map<string, RenderedDiagram>();
...
<body>
   ...
   */
  private async htmlToPDF(html: string, options: Required<PDFOptions>): Promise<Buffer> {
