...
class FinalMermaidToPdfConverter {
    ...
    validateAndSanitizeOptions(options) {
        ...
        // Validate engine
        if (options.engine) {
            const validEngines = ['puppeteer', 'pdfkit'];
...
exports.FinalMermaidToPdfConverter = FinalMermaidToPdfConverter;
